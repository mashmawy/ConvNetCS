...
namespace ConvNetExample
{
    class Program
    {
        ...
        public static Tuple<double[][], double[]> cifarTrainingData(int trainigCount = 50000)
        {
        ...
        public static Tuple<double[][], double[]> cifarTestData(int trainigCount = 10000)
        {
        ...
        { 
            ...
            for (int ep = 0; ep < 40; ep++)
            {
                ...
                for (int we = 0; we < data.Length; we++)
                {
                    ...
                    var acc = (double)good * 100.0 / (double)all;
        ...
        static void Main(string[] args)
        {
            ...
            Console.WriteLine("Start testing the model");
            Test();
        }
    }
}
